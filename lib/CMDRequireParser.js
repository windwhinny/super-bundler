    ...
    if (deeps === 0) {
        try{
            self.stream.emit('data',{
                code: ';(function(global){var ms=[];function r(i){return ms[i]};r.modules=ms;global.$$$require=r;})("undefined"==typeof module?window:global);',
                name: '$$$require'
            });
        } catch(e) {
...
Task.prototype.replaceReq = function(content, reqs){
    ...
    return ';(function(){var m={exports: {}};(function(require, modle, exports){\n'+
        content+
        '\n})($$$require,m,m.exports);$$$require.modules.push(m.exports||{});})();'
};
